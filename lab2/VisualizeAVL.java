...
public class VisualizeAVL extends JPanel implements ActionListener {
     ...
     *
     * @param n     - root of subtree (AVLTreeNode)
     * @param left  - used to calculate how far to the left to place the sub tree
     *              (int)
     * @param right - used to calculate how far to the right to place the sub tree
     *              (int)
     * @param top   - used to calculate how far from the top to place the sub tree
     *              (int)
     */
